    ...
    <section id="vision" data-testid="vision-section" className="py-24 sm:py-32 lg:py-40">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 grid lg:grid-cols-2 gap-10 lg:gap-16">
        <article
          ...
          className="bg-[#1E4D8C] text-[#FDFBF7] p-10 sm:p-14 relative"
        >
          <p className="overline mb-8" style={{ color: "#F5C518" }}>◆ 02 — Our Vision</p>
          <h3 className="font-display text-4xl sm:text-5xl leading-[1.1] text-[#FDFBF7]">
            To be the studio where <span className="italic text-[#F5C518]">creativity meets strategy</span>
          ...
          <div className="absolute top-6 right-6 text-[#F5C518] font-display italic text-5xl opacity-30 select-none">02</div>
        </article>

        <article
          data-testid="mission-card"
          className="bg-[#FDFBF7] border border-[#1E4D8C]/10 p-10 sm:p-14 relative"
        >
          <p className="overline mb-8">◆ 03 — Our Mission</p>
          <h3 className="font-display text-4xl sm:text-5xl leading-[1.1] text-[#1E4D8C]">
          ...
          <div className="absolute top-6 right-6 text-[#F5C518] font-display italic text-5xl opacity-30 select-none">03</div>
        </article>
      </div>
    </section>
  );
